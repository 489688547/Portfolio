...
function submitForm() {
    ...
    //     data: "name=" + t + "&email=" + e + "&msg_subject=" + i + "&message=" + n,
    //     success: function (t) {
...
function submitMSG(t, e) {
    if (t) i = "h3 text-center tada animated text-success";
    else var i = "h3 text-center text-danger";
    $("#msgSubmit").removeClass().addClass(i).text(e)
}
if (function (t, e) {
        "use strict";
        ...
        function f(t, e, i) {
            ...
            if (void 0 === i && 1 === t.nodeType)
                if (n = "data-" + e.replace(Qt, "-$&").toLowerCase(), "string" == typeof (i = t.getAttribute(n))) {
                    try {
                        i = p(i)
                    } catch (t) {}
                    Lt.set(t, e, i)
        ...
        function m(t) {
            var e, i = t.ownerDocument,
                n = t.nodeName,
                r = Ft[n];
            return r || (e = i.body.appendChild(i.createElement(n)), r = ft.css(e, "display"), e.parentNode.removeChild(e), "none" === r && (r = "block"), Ft[n] = r, r)
        }

        function y(t, e) {
            for (var i, n, r = [], o = 0, s = t.length; o < s; o++)(n = t[o]).style && (i = n.style.display, e ? ("none" === i && (r[o] = kt.get(n, "display") || null, r[o] || (n.style.display = "")), "" === n.style.display && Mt(n) && (r[o] = m(n))) : "none" !== i && (r[o] = "none", kt.set(n, "display", i)));
        ...
        function b(t, e, i, n, r) {
            for (var o, s, a, l, u, c, h = e.createDocumentFragment(), d = [], p = 0, f = t.length; p < f; p++)
                ...
                for (s = s || h.appendChild(e.createElement("div")), a = (Vt.exec(o) || ["", ""])[1].toLowerCase(), l = qt[a] || qt._default, s.innerHTML = l[1] + ft.htmlPrefilter(o) + l[2], c = l[0]; c--;) s = s.lastChild;
                ft.merge(d, s.childNodes), (s = h.firstChild).textContent = ""
            } else d.push(e.createTextNode(o));
            for (h.textContent = "", p = 0; o = d[p++];)
                if (n && ft.inArray(o, n) > -1) r && r.push(o);
                else if (u = ft.contains(o.ownerDocument, o), s = v(h.appendChild(o), "script"), u && _(s), i)
                for (c = 0; o = s[c++];) $t.test(o.type || "") && i.push(o);
            return h
        }
        ...
        function I(t, e) {
            ...
            if (1 === e.nodeType) {
                if (kt.hasData(t) && (o = kt.access(t), s = kt.set(e, o), u = o.events)) {
                    ...
                    for (r in u)
                        for (i = 0, n = u[r].length; i < n; i++) ft.event.add(e, r, u[r][i])
                }
        ...
        function D(t, e, n, r) {
            ...
            if (g || d > 1 && "string" == typeof f && !dt.checkClone && ee.test(f)) return t.each(function (i) {
                var o = t.eq(i);
                g && (e[0] = f.call(this, i, o.html())), D(o, e, n, r)
            });
            if (d && (o = b(e, t[0].ownerDocument, !1, t, r), s = o.firstChild, 1 === o.childNodes.length && (o = s), s || r)) {
                for (l = (a = ft.map(v(o, "script"), P)).length; h < d; h++) u = o, h !== p && (u = ft.clone(u, !0, !0), l && ft.merge(a, v(u, "script"))), n.call(t[h], u, h);
                if (l)
                    for (c = a[a.length - 1].ownerDocument, ft.map(a, S), h = 0; h < l; h++) u = a[h], $t.test(u.type || "") && !kt.access(u, "globalEval") && ft.contains(c, u) && (u.src ? ft._evalUrl && ft._evalUrl(u.src) : i(u.textContent.replace(ne, ""), c))
            }
            return t
        }

        function O(t, e, i) {
            for (var n, r = e ? ft.filter(e, t) : t, o = 0; null != (n = r[o]); o++) i || 1 !== n.nodeType || ft.cleanData(v(n)), n.parentNode && (i && ft.contains(n.ownerDocument, n) && _(v(n, "script")), n.parentNode.removeChild(n));
            return t
        }

        function j(t, e, i) {
            var n, r, o, s, a = t.style;
            return (i = i || se(t)) && ("" !== (s = i.getPropertyValue(e) || i[e]) || ft.contains(t.ownerDocument, t) || (s = ft.style(t, e)), !dt.pixelMarginRight() && oe.test(s) && re.test(e) && (n = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = i.width, a.width = n, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
        }
        ...
        function k(t) {
            ...
            for (var e = t[0].toUpperCase() + t.slice(1), i = he.length; i--;)
                if ((t = he[i] + e) in de) return t
        }

        function L(t) {
            var e = ft.cssProps[t];
            return e || (e = ft.cssProps[t] = k(t) || t), e
        }
        ...
        function Q(t, e, i, n, r) {
            var o, s = 0;
            for (o = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0; o < 4; o += 2) "margin" === i && (s += ft.css(t, i + Wt[o], !0, r)), n ? ("content" === i && (s -= ft.css(t, "padding" + Wt[o], !0, r)), "margin" !== i && (s -= ft.css(t, "border" + Wt[o] + "Width", !0, r))) : (s += ft.css(t, "padding" + Wt[o], !0, r), "padding" !== i && (s += ft.css(t, "border" + Wt[o] + "Width", !0, r)));
            return s
        }
        ...
        function R(t, e, i) {
            ...
            return oe.test(o) ? o : (n = s && (dt.boxSizingReliable() || o === t.style[e]), "auto" === o && (o = t["offset" + e[0].toUpperCase() + e.slice(1)]), (o = parseFloat(o) || 0) + Q(t, e, i || (s ? "border" : "content"), n, r) + "px")
        }
        ...
        function W() {
            fe && (!1 === et.hidden && t.requestAnimationFrame ? t.requestAnimationFrame(W) : t.setTimeout(W, ft.fx.interval), ft.fx.tick())
        }
        ...
        function F(t, e, i) {
            for (var n, r = (V.tweeners[e] || []).concat(V.tweeners["*"]), o = 0, s = r.length; o < s; o++)
        ...
        function B(t, e) {
            var i, n, r, o, s;
            for (i in t)
                if (n = ft.camelCase(i), r = e[n], o = t[i], Array.isArray(o) && (r = o[1], o = t[i] = o[0]), i !== n && (t[n] = o, delete t[i]), (s = ft.cssHooks[n]) && "expand" in s) {
        ...
        function V(t, e, i) {
            var n, r, o = 0,
                ...
                l = function () {
                    if (r) return !1;
                    for (var e = pe || M(), i = Math.max(0, u.startTime + u.duration - e), n = 1 - (i / u.duration || 0), o = 0, s = u.tweens.length; o < s; o++) u.tweens[o].run(n);
            ...
            for (B(c, u.opts.specialEasing); o < s; o++)
                if (n = V.prefilters[o].call(u, t, c, u.opts)) return ft.isFunction(n.stop) && (ft._queueHooks(u.elem, u.opts.queue).stop = ft.proxy(n.stop, n)), n;
            return ft.map(c, F, u), ft.isFunction(u.opts.start) && u.opts.start.call(t, u), u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always), ft.fx.timer(ft.extend(l, {
                elem: t,
                anim: u,
                queue: u.opts.queue
            })), u
        ...
        ft.fn = ft.prototype = {
            ...
            for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || ft.isFunction(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
                if (null != (t = arguments[a]))
                    for (e in t) i = s[e], n = t[e], s !== n && (u && n && (ft.isPlainObject(n) || (r = Array.isArray(n))) ? (r ? (r = !1, o = i && Array.isArray(i) ? i : []) : o = i && ft.isPlainObject(i) ? i : {}, s[e] = ft.extend(u, o, n)) : void 0 !== n && (s[e] = n));
            return s
        }, ft.extend({
        ...
        var _t = function (t) {
            function e(t, e, i, n) {
                var r, o, s, a, l, c, d, p = e && e.ownerDocument,
                    f = e ? e.nodeType : 9;
                if (i = i || [], "string" != typeof t || !t || 1 !== f && 9 !== f && 11 !== f) return i;
                if (!n && ((e ? e.ownerDocument || e : z) !== O && D(e), e = e || O, Y)) {
                    if (11 !== f && (l = gt.exec(t)))
                        if (r = l[1]) {
                            if (9 === f) {
                                if (!(s = e.getElementById(r))) return i;
                                if (s.id === r) return i.push(s), i
                            } else if (p && (s = p.getElementById(r)) && Q(e, s) && s.id === r) return i.push(s), i
                        } else {
                        ...
                        } if (b.qsa && !B[t + " "] && (!k || !k.test(t))) {
                        if (1 !== f) p = e, d = t;
                        else if ("object" !== e.nodeName.toLowerCase()) {
                            for ((a = e.getAttribute("id")) ? a = a.replace(_t, bt) : e.setAttribute("id", a = R), o = (c = E(t)).length; o--;) c[o] = "#" + a + " " + h(c[o]);
            ...
            function d(t, e, i) {
                ...
                return e.first ? function (e, i, r) {
                    ...
                    if (l) {
                        ...
                        for (; e = e[n];)
                            if (1 === e.nodeType || s)
                                if (h = e[R] || (e[R] = {}), c = h[e.uniqueID] || (h[e.uniqueID] = {}), r && r === e.nodeName.toLowerCase()) e = e[n] || e;
                                else {
            ...
            function m(t, e, i, r, o, s) {
                return r && !r[R] && (r = m(r)), o && !o[R] && (o = m(o, s)), n(function (n, s, a, l) {
                    var u, c, h, d = [],
                        p = [],
                        m = s.length,
                        y = n || f(e || "*", a.nodeType ? [a] : a, []),
                        v = !t || !n && e ? y : g(y, d, t, a, l),
                        _ = i ? o || (n ? t : m || r) ? [] : s : v;
                    if (i && i(v, _, a, l), r)
                        for (u = g(_, p), r(u, [], a, l), c = u.length; c--;)(h = u[c]) && (_[p[c]] = !(v[p[c]] = h));
                    if (n) {
                        if (o || t) {
                            if (o) {
                            ...
                            for (c = _.length; c--;)(h = _[c]) && (u = o ? Z(n, h) : d[c]) > -1 && (n[u] = !(s[u] = h))
                        }
                    } else _ = g(_ === s ? _.splice(m, _.length) : _), o ? o(null, s, _, l) : K.apply(s, _)
                })
            }

            function y(t) {
                for (var e, i, n, r = t.length, o = T.relative[t[0].type], s = o || T.relative[" "], a = o ? 1 : 0, l = d(function (t) {
                        return t === e
                    }, s, !0), u = d(function (t) {
                        return Z(e, t) > -1
                    }, s, !0), c = [function (t, i, n) {
                        var r = !o && (n || i !== S) || ((e = i).nodeType ? l(t, i, n) : u(t, i, n));
                        return e = null, r
                    }]; a < r; a++)
                    if (i = T.relative[t[a].type]) c = [d(p(c), i)];
                    else {
                        if ((i = T.filter[t[a].type].apply(null, t[a].matches))[R]) {
                            ...
                            return m(a > 1 && p(c), a > 1 && h(t.slice(0, a - 1).concat({
                                value: " " === t[a - 2].type ? "*" : ""
                            })).replace(ot, "$1"), i, a < n && y(t.slice(a, n)), n < r && y(t = t.slice(n)), n < r && h(t))
                        }
                        c.push(i)
                    } return p(c)
            }
                ...
                var r = i.length > 0,
                    ...
                    s = function (n, s, a, l, u) {
                        var c, h, d, p = 0,
                            ...
                            w = _.length;
                        for (u && (S = s === O || s || u); f !== w && null != (c = _[f]); f++) {
                            if (o && c) {
                                for (h = 0, s || c.ownerDocument === O || (D(c), a = !Y); d = t[h++];)
                                    if (d(c, s || O, a)) {
                                        l.push(c);
                                        break
                                    } u && (W = b)
                        ...
                        if (p += f, r && f !== p) {
                            for (h = 0; d = i[h++];) d(m, y, s, a);
                            if (n) {
                                if (p > 0)
                                    for (; f--;) m[f] || y[f] || (y[f] = U.call(l));
                                y = g(y)
                            }
                            K.apply(l, y), u && !n && y.length > 0 && p + i.length > 1 && e.uniqueSort(l)
                        }
                        return u && (W = b, S = v), m
                    };
                return r ? n(s) : s
            }
            var _, b, T, w, C, E, x, P, S, I, A, D, O, j, Y, k, L, N, Q, R = "sizzle" + 1 * new Date,
                z = t.document,
                W = 0,
                M = 0,
                H = i(),
            ...
            try {
                K.apply(q = X.call(z.childNodes), z.childNodes), q[z.childNodes.length].nodeType
            } catch (t) {
                K = {
            ...
            b = e.support = {}, C = e.isXML = function (t) {
                ...
                return n !== O && 9 === n.nodeType && n.documentElement ? (O = n, j = O.documentElement, Y = !C(O), z !== O && (i = O.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", Tt, !1) : i.attachEvent && i.attachEvent("onunload", Tt)), b.attributes = r(function (t) {
                    return t.className = "i", !t.getAttribute("className")
                }), b.getElementsByTagName = r(function (t) {
                    return t.appendChild(O.createComment("")), !t.getElementsByTagName("*").length
                }), b.getElementsByClassName = ft.test(O.getElementsByClassName), b.getById = r(function (t) {
                ...
                }, L = [], k = [], (b.qsa = ft.test(O.querySelectorAll)) && (r(function (t) {
                    ...
                    e.setAttribute("type", "hidden"), t.appendChild(e).setAttribute("name", "D"), t.querySelectorAll("[name=d]").length && k.push("name" + tt + "*[*^$|!~]?="), 2 !== t.querySelectorAll(":enabled").length && k.push(":enabled", ":disabled"), j.appendChild(t).disabled = !0, 2 !== t.querySelectorAll(":disabled").length && k.push(":enabled", ":disabled"), t.querySelectorAll("*,:x"), k.push(",.*:")
                })), (b.matchesSelector = ft.test(N = j.matches || j.webkitMatchesSelector || j.mozMatchesSelector || j.oMatchesSelector || j.msMatchesSelector)) && r(function (t) {
                    b.disconnectedMatch = N.call(t, "*"), N.call(t, "[s!='']:x"), L.push("!=", nt)
                }), k = k.length && new RegExp(k.join("|")), L = L.length && new RegExp(L.join("|")), e = ft.test(j.compareDocumentPosition), Q = e || ft.test(j.contains) ? function (t, e) {
                    ...
                    return i || (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & i || !b.sortDetached && e.compareDocumentPosition(t) === i ? t === O || t.ownerDocument === z && Q(z, t) ? -1 : e === O || e.ownerDocument === z && Q(z, e) ? 1 : I ? Z(I, t) - Z(I, e) : 0 : 4 & i ? -1 : 1)
                } : function (t, e) {
                    if (t === e) return A = !0, 0;
                    var i, n = 0,
                        r = t.parentNode,
                        ...
                        a = [t],
                        l = [e];
                    if (!r || !o) return t === O ? -1 : e === O ? 1 : r ? -1 : o ? 1 : I ? Z(I, t) - Z(I, e) : 0;
                    if (r === o) return s(t, e);
                ...
                if ((t.ownerDocument || t) !== O && D(t), i = i.replace(lt, "='$1']"), b.matchesSelector && Y && !B[i + " "] && (!L || !L.test(i)) && (!k || !k.test(i))) try {
                    var n = N.call(t, i);
                    if (n || b.disconnectedMatch || t.document && 11 !== t.document.nodeType) return n
                } catch (t) {}
                return e(i, O, null, [t]).length > 0
            }, e.contains = function (t, e) {
                return (t.ownerDocument || t) !== O && D(t), Q(t, e)
            }, e.attr = function (t, e) {
                (t.ownerDocument || t) !== O && D(t);
                var i = T.attrHandle[e.toLowerCase()],
                    n = i && $.call(T.attrHandle, e.toLowerCase()) ? i(t, e, !Y) : void 0;
                return void 0 !== n ? n : b.attributes || !Y ? t.getAttribute(e) : (n = t.getAttributeNode(e)) && n.specified ? n.value : null
            }, e.escape = function (t) {
                ...
                var e, i = [],
                    n = 0,
                    r = 0;
                if (A = !b.detectDuplicates, I = !b.sortStable && t.slice(0), t.sort(V), A) {
                ...
                preFilter: {
                    ...
                    PSEUDO: function (t) {
                        var e, i = !t[6] && t[2];
                        return ht.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && ut.test(i) && (e = E(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e), t[2] = i.slice(0, e)), t.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function (t) {
                        ...
                        return 1 === n && 0 === r ? function (t) {
                            ...
                            if (m) {
                                ...
                                if (f = [s ? m.firstChild : m.lastChild], s && v) {
                                    for (_ = (p = (u = (c = (h = (d = m)[R] || (d[R] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[t] || [])[0] === W && u[1]) && u[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (_ = p = 0) || f.pop();)
                                        if (1 === d.nodeType && ++_ && d === e) {
                                            c[t] = [W, p, _];
                                            break
                                        }
                                } else if (v && (d = e, h = d[R] || (d[R] = {}), c = h[d.uniqueID] || (h[d.uniqueID] = {}), u = c[t] || [], p = u[0] === W && u[1], _ = p), !1 === _)
                                    for (;
                                        (d = ++p && d && d[g] || (_ = p = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== y : 1 !== d.nodeType) || !++_ || (v && (h = d[R] || (d[R] = {}), c = h[d.uniqueID] || (h[d.uniqueID] = {}), c[t] = [W, _]), d !== e)););
                    ...
                    PSEUDO: function (t, i) {
                        ...
                        return o[R] ? o(i) : o.length > 1 ? (r = [t, t, "", i], T.setFilters.hasOwnProperty(t.toLowerCase()) ? n(function (t, e) {
                            for (var n, r = o(t, i), s = r.length; s--;) n = Z(t, r[s]), t[n] = !(e[n] = r[s])
                        }) : function (t) {
                            return o(t, 0, r)
                        }) : o
                    }
                ...
                pseudos: {
                    ...
                    lang: n(function (t) {
                        return ct.test(t || "") || e.error("unsupported lang: " + t), t = t.replace(yt, vt).toLowerCase(),
                            function (e) {
                                var i;
                                do {
            ...
            return c.prototype = T.filters = T.pseudos, T.setFilters = new c, E = e.tokenize = function (t, i) {
                var n, r, o, s, a, l, u, c = F[t + " "];
                ...
                for (a = t, l = [], u = T.preFilter; a;) {
                    ...
                    for (s in T.filter) !(r = ht[s].exec(a)) || u[s] && !(r = u[s](r)) || (n = r.shift(), o.push({
                        value: n,
                        type: s,
                        matches: r
                    }), a = a.slice(n.length));
                ...
                var i, n = [],
                    ...
                    o = B[t + " "];
                if (!o) {
                    for (e || (e = E(t)), i = e.length; i--;) o = y(e[i]), o[R] ? n.push(o) : r.push(o);
                    (o = B(t, v(r, n))).selector = t
                }
                return o
            }, P = e.select = function (t, e, i, n) {
                var r, o, s, a, l, c = "function" == typeof t && t,
                    d = !n && E(t = c.selector || t);
                if (i = i || [], 1 === d.length) {
                    if ((o = d[0] = d[0].slice(0)).length > 2 && "ID" === (s = o[0]).type && 9 === e.nodeType && Y && T.relative[o[1].type]) {
                        if (!(e = (T.find.ID(s.matches[0].replace(yt, vt), e) || [])[0])) return i;
                        c && (e = e.parentNode), t = t.slice(o.shift().value.length)
                    }
                    for (r = ht.needsContext.test(t) ? 0 : o.length; r-- && (s = o[r], !T.relative[a = s.type]);)
                        if ((l = T.find[a]) && (n = l(s.matches[0].replace(yt, vt), mt.test(o[0].type) && u(e.parentNode) || e))) {
                            if (o.splice(r, 1), !(t = n.length && h(o))) return K.apply(i, n), i;
                            break
                        }
                }
                return (c || x(t, d))(n, e, !Y, i, !e || mt.test(t) && u(e.parentNode) || e), i
            }, b.sortStable = R.split("").sort(V).join("") === R, b.detectDuplicates = !!A, D(), b.sortDetached = r(function (t) {
        ...
        ft.find = _t, ft.expr = _t.selectors, ft.expr[":"] = ft.expr.pseudos, ft.uniqueSort = ft.unique = _t.uniqueSort, ft.text = _t.getText, ft.isXMLDoc = _t.isXML, ft.contains = _t.contains, ft.escapeSelector = _t.escape;
        ...
        (ft.fn.init = function (t, e, i) {
            ...
            if (i = i || xt, "string" == typeof t) {
                ...
                if (n[1]) {
                    if (e = e instanceof ft ? e[0] : e, ft.merge(this, ft.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : et, !0)), Ct.test(n[1]) && ft.isPlainObject(e))
        ...
        ft.fn.extend({
            ...
            ft.fn[t] = function (i, n) {
                ...
                return "Until" !== t.slice(-5) && (n = i), n && "string" == typeof n && (r = ft.filter(n, r)), this.length > 1 && (It[t] || ft.uniqueSort(r), St.test(t) && r.reverse()), this.pushStack(r)
            }
        });
        var At = /[^\x20\t\r\n\f]+/g;
        ft.Callbacks = function (t) {
            ...
            var e, i, n, r, o = [],
                ...
                u = function () {
                    for (r = r || t.once, n = e = !0; s.length; l = -1)
                        for (i = s.shift(); ++l < o.length;) !1 === o[l].apply(i[0], i[1]) && t.stopOnFalse && (l = o.length, i = !1);
                    t.memory || (i = !1), e = !1, r && (o = i ? [] : "")
                },
                c = {
                    add: function () {
                        return o && (i && !e && (l = o.length - 1, s.push(i)), function e(i) {
            ...
            Deferred: function (e) {
                    ...
                    r = {
                        ...
                        then: function (e, n, r) {
                                    ...
                                    var a = this,
                                        ...
                                        h = function () {
                                            ...
                                            if (!(e < s)) {
                                                ...
                                                h = t && ("object" == typeof t || "function" == typeof t) && t.then, ft.isFunction(h) ? r ? h.call(t, o(s, i, l, r), o(s, i, u, r)) : (s++, h.call(t, o(s, i, l, r), o(s, i, u, r), o(s, i, l, i.notifyWith))) : (n !== l && (a = void 0, c = [t]), (r || i.resolveWith)(a, c))
                                            }
                                        },
                                        d = r ? h : function () {
                                            try {
                                                ...
                                                ft.Deferred.exceptionHook && ft.Deferred.exceptionHook(t, d.stackTrace), e + 1 >= s && (n !== u && (a = void 0, c = [t]), i.rejectWith(a, c))
                                            }
                                        };
                            ...
                            return ft.Deferred(function (t) {
                                i[0][3].add(o(0, t, ft.isFunction(r) ? r : l, t.notifyWith)), i[1][3].add(o(0, t, ft.isFunction(e) ? e : l)), i[2][3].add(o(0, t, ft.isFunction(n) ? n : u))
                            }).promise()
                        },
                        promise: function (t) {
                ...
                return ft.each(i, function (t, e) {
                    ...
                    r[e[1]] = s.add, a && s.add(function () {
                        n = a
                    }, i[3 - t][2].disable, i[0][2].lock), s.add(e[3].fire), o[e[0]] = function () {
            ...
            when: function (t) {
                var e = arguments.length,
                    ...
                    s = function (t) {
                        return function (i) {
                            n[t] = this, r[t] = arguments.length > 1 ? nt.call(arguments) : i, --e || o.resolveWith(n, r)
                        }
                    };
                if (e <= 1 && (c(t, o.done(s(i)).resolve, o.reject, !e), "pending" === o.state() || ft.isFunction(r[i] && r[i].then))) return o.then();
                for (; i--;) c(r[i], s(i), o.reject);
                return o.promise()
            }
        });
        ...
        ft.fn.ready = function (t) {
            ...
            readyWait: 1,
            ready: function (t) {
                (!0 === t ? --ft.readyWait : ft.isReady) || (ft.isReady = !0, !0 !== t && --ft.readyWait > 0 || Ot.resolveWith(et, [ft]))
            }
        ...
        var jt = function (t, e, i, n, r, o, s) {
                ...
                } else if (void 0 !== n && (r = !0, ft.isFunction(n) || (s = !0), u && (s ? (e.call(t, n), e = null) : (u = e, e = function (t, e, i) {
        ...
        d.uid = 1, d.prototype = {
            ...
            remove: function (t, e) {
                ...
                if (void 0 !== n) {
                    if (void 0 !== e) {
                        Array.isArray(e) ? e = e.map(ft.camelCase) : (e = ft.camelCase(e), e = e in n ? [e] : e.match(At) || []), i = e.length;
                        for (; i--;) delete n[e[i]]
        ...
        ft.extend({
            hasData: function (t) {
                return Lt.hasData(t) || kt.hasData(t)
            },
            data: function (t, e, i) {
            ...
            data: function (t, e) {
                var i, n, r, o = this[0],
                    s = o && o.attributes;
                if (void 0 === t) {
                    if (this.length && (r = Lt.get(o), 1 === o.nodeType && !kt.get(o, "hasDataAttrs"))) {
                        for (i = s.length; i--;) s[i] && 0 === (n = s[i].name).indexOf("data-") && (n = ft.camelCase(n.slice(5)), f(o, n, r[n]));
                ...
                return "object" == typeof t ? this.each(function () {
                    ...
                    var i;
                    if (o && void 0 === e) {
                        if (void 0 !== (i = Lt.get(o, t))) return i;
            ...
            queue: function (t, e, i) {
                var n;
                if (t) return e = (e || "fx") + "queue", n = kt.get(t, e), i && (!n || Array.isArray(i) ? n = kt.access(t, e, ft.makeArray(i)) : n.push(i)), n || []
            },
            ...
            promise: function (t, e) {
                ...
                for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; s--;)(i = kt.get(o[s], t + "queueHooks")) && i.empty && (n++, i.empty.add(a));
                return a(), r.promise(e)
            }
        });
        var Rt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
            zt = new RegExp("^(?:([+-])=|)(" + Rt + ")([a-z%]*)$", "i"),
        ...
        ft.event = {
            ...
            add: function (t, e, i, n, r) {
                var o, s, a, l, u, c, h, d, p, f, g, m = kt.get(t);
                if (m)
                    for (i.handler && (o = i, i = o.handler, r = o.selector), r && ft.find.matchesSelector(Gt, r), i.guid || (i.guid = ft.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (e) {
                            return void 0 !== ft && ft.event.triggered !== e.type ? ft.event.dispatch.apply(t, arguments) : void 0
                        }), u = (e = (e || "").match(At) || [""]).length; u--;) a = Zt.exec(e[u]) || [], p = g = a[1], f = (a[2] || "").split(".").sort(), p && (h = ft.event.special[p] || {}, p = (r ? h.delegateType : h.bindType) || p, h = ft.event.special[p] || {}, c = ft.extend({
                        type: p,
                        origType: g,
                        data: n,
                        handler: i,
                        ...
                        namespace: f.join(".")
                    }, o), (d = l[p]) || (d = l[p] = [], d.delegateCount = 0, h.setup && !1 !== h.setup.call(t, n, f, s) || t.addEventListener && t.addEventListener(p, s)), h.add && (h.add.call(t, c), c.handler.guid || (c.handler.guid = i.guid)), r ? d.splice(d.delegateCount++, 0, c) : d.push(c), ft.event.global[p] = !0)
            },
            remove: function (t, e, i, n, r) {
                var o, s, a, l, u, c, h, d, p, f, g, m = kt.hasData(t) && kt.get(t);
                if (m && (l = m.events)) {
                    for (u = (e = (e || "").match(At) || [""]).length; u--;)
                        if (a = Zt.exec(e[u]) || [], p = g = a[1], f = (a[2] || "").split(".").sort(), p) {
                            for (h = ft.event.special[p] || {}, d = l[p = (n ? h.delegateType : h.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = d.length; o--;) c = d[o], !r && g !== c.origType || i && i.guid !== c.guid || a && !a.test(c.namespace) || n && n !== c.selector && ("**" !== n || !c.selector) || (d.splice(o, 1), c.selector && d.delegateCount--, h.remove && h.remove.call(t, c));
                            s && !d.length && (h.teardown && !1 !== h.teardown.call(t, f, m.handle) || ft.removeEvent(t, p, m.handle), delete l[p])
                        } else
                            for (p in l) ft.event.remove(t, p + e[u], i, n, !0);
                    ft.isEmptyObject(l) && kt.remove(t, "handle events")
                }
            },
            dispatch: function (t) {
                var e, i, n, r, o, s, a = ft.event.fix(t),
                    l = new Array(arguments.length),
                    u = (kt.get(this, "events") || {})[a.type] || [],
                    c = ft.event.special[a.type] || {};
                for (l[0] = a, e = 1; e < arguments.length; e++) l[e] = arguments[e];
                if (a.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, a)) {
                    for (s = ft.event.handlers.call(this, a, u), e = 0;
                        (r = s[e++]) && !a.isPropagationStopped();)
                        for (a.currentTarget = r.elem, i = 0;
                            (o = r.handlers[i++]) && !a.isImmediatePropagationStopped();) a.rnamespace && !a.rnamespace.test(o.namespace) || (a.handleObj = o, a.data = o.data, void 0 !== (n = ((ft.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, l)) && !1 === (a.result = n) && (a.preventDefault(), a.stopPropagation()));
                ...
                if (l && u.nodeType && !("click" === t.type && t.button >= 1))
                    for (; u !== this; u = u.parentNode || this)
                        if (1 === u.nodeType && ("click" !== t.type || !0 !== u.disabled)) {
                            for (o = [], s = {}, i = 0; i < l; i++) n = e[i], r = n.selector + " ", void 0 === s[r] && (s[r] = n.needsContext ? ft(r, this).index(u) > -1 : ft.find(r, this, null, [u]).length), s[r] && o.push(n);
                            o.length && a.push({
                                elem: u,
                                handlers: o
                            })
            ...
            return this instanceof ft.Event ? (t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? T : w, this.target = t.target && 3 === t.target.nodeType ? t.target.parentNode : t.target, this.currentTarget = t.currentTarget, this.relatedTarget = t.relatedTarget) : this.type = t, e && ft.extend(this, e), this.timeStamp = t && t.timeStamp || ft.now(), void(this[ft.expando] = !0)) : new ft.Event(t, e)
        }, ft.Event.prototype = {
            ...
            which: function (t) {
                var e = t.button;
                return null == t.which && Kt.test(t.type) ? null != t.charCode ? t.charCode : t.keyCode : !t.which && void 0 !== e && Xt.test(t.type) ? 1 & e ? 1 : 2 & e ? 3 : 4 & e ? 2 : 0 : t.which
            }
        ...
        ft.extend({
            ...
            clone: function (t, e, i) {
                ...
                if (!(dt.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ft.isXMLDoc(t)))
                    for (s = v(a), o = v(t), n = 0, r = o.length; n < r; n++) A(o[n], s[n]);
                if (e)
                    if (i)
                        for (o = o || v(t), s = s || v(a), n = 0, r = o.length; n < r; n++) I(o[n], s[n]);
                    else I(t, a);
                return (s = v(a, "script")).length > 0 && _(s, !l && v(t, "script")), a
            },
            cleanData: function (t) {
                for (var e, i, n, r = ft.event.special, o = 0; void 0 !== (i = t[o]); o++)
                    if (Yt(i)) {
                        if (e = i[kt.expando]) {
                            if (e.events)
            ...
            html: function (t) {
                return jt(this, function (t) {
                    ...
                    if ("string" == typeof t && !te.test(t) && !qt[(Vt.exec(t) || ["", ""])[1].toLowerCase()]) {
            ...
            ft.fn[t] = function (t) {
                for (var i, n = [], r = ft(t), o = r.length - 1, s = 0; s <= o; s++) i = s === o ? this : this.clone(!0), ft(r[s])[e](i), ot.apply(n, i.get());
        ...
        ! function () {
            function e() {
                if (a) {
                    ...
                    i = "1%" !== e.top, o = "2px" === e.marginLeft, n = "4px" === e.width, a.style.marginRight = "50%", r = "4px" === e.marginRight, Gt.removeChild(s), a = null
                }
            }
            var i, n, r, o, s = et.createElement("div"),
        ...
        ft.extend({
            ...
            style: function (t, e, i, n) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    var r, o, s, a = ft.camelCase(e),
                        l = le.test(e),
                        u = t.style;
                    return l || (e = L(a)), s = ft.cssHooks[e] || ft.cssHooks[a], void 0 === i ? s && "get" in s && void 0 !== (r = s.get(t, !1, n)) ? r : u[e] : ("string" === (o = typeof i) && (r = zt.exec(i)) && r[1] && (i = g(t, e, r), o = "number"), void(null != i && i === i && ("number" === o && (i += r && r[3] || (ft.cssNumber[a] ? "" : "px")), dt.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (u[e] = "inherit"), s && "set" in s && void 0 === (i = s.set(t, i, n)) || (l ? u.setProperty(e, i) : u[e] = i))))
                }
            },
            css: function (t, e, i, n) {
                var r, o, s, a = ft.camelCase(e);
                return le.test(e) || (e = L(a)), (s = ft.cssHooks[e] || ft.cssHooks[a]) && "get" in s && (r = s.get(t, !0, i)), void 0 === r && (r = j(t, e, n)), "normal" === r && e in ce && (r = ce[e]), "" === i || i ? (o = parseFloat(r), !0 === i || isFinite(o) ? o || 0 : r) : r
            }
        }), ft.each(["height", "width"], function (t, e) {
            ft.cssHooks[e] = {
                get: function (t, i, n) {
                    if (i) return !ae.test(ft.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? R(t, e, n) : Ht(t, ue, function () {
                        return R(t, e, n)
                    })
                },
                set: function (t, i, n) {
                    var r, o = n && se(t),
                        s = n && Q(t, e, n, "border-box" === ft.css(t, "boxSizing", !1, o), o);
                    return s && (r = zt.exec(i)) && "px" !== (r[3] || "px") && (t.style[e] = i, i = ft.css(t, e)), N(t, i, s)
                }
            }
        }), ft.cssHooks.marginLeft = Y(dt.reliableMarginLeft, function (t, e) {
            ...
            ft.cssHooks[t + e] = {
                expand: function (i) {
                    for (var n = 0, r = {}, o = "string" == typeof i ? i.split(" ") : [i]; n < 4; n++) r[t + Wt[n] + e] = o[n] || o[n - 2] || o[0];
                    return r
                }
            }, re.test(t) || (ft.cssHooks[t + e].set = N)
        }), ft.fn.extend({
            css: function (t, e) {
                return jt(this, function (t, e, i) {
                    var n, r, o = {},
                        s = 0;
                    if (Array.isArray(e)) {
                        for (n = se(t), r = e.length; s < r; s++) o[e[s]] = ft.css(t, e[s], !1, n);
                        return o
                    }
        ...
        ft.Animation = ft.extend(V, {
                tweeners: {
                    "*": [function (t, e) {
                        ...
                        return g(i.elem, t, zt.exec(e), i), i
                    }]
                },
                ...
                prefilters: [function (t, e, i) {
                    var n, r, o, s, a, l, u, c, h = "width" in e || "height" in e,
                        ...
                        g = t.nodeType && Mt(t),
                        m = kt.get(t, "fxshow");
                    i.queue || (null == (s = ft._queueHooks(t, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function () {
                        s.unqueued || a()
                    ...
                    for (n in e)
                        ...
                        h && 1 === t.nodeType && (i.overflow = [f.overflow, f.overflowX, f.overflowY], null == (u = m && m.display) && (u = kt.get(t, "display")), "none" === (c = ft.css(t, "display")) && (u ? c = u : (y([t], !0), u = t.style.display || u, c = ft.css(t, "display"), y([t]))), ("inline" === c || "inline-block" === c && null != u) && "none" === ft.css(t, "float") && (l || (d.done(function () {
                            f.display = u
                        }), null == u && (c = f.display, u = "none" === c ? "" : c)), f.display = "inline-block")), i.overflow && (f.overflow = "hidden", d.always(function () {
                            f.overflow = i.overflow[0], f.overflowX = i.overflow[1], f.overflowY = i.overflow[2]
                        })), l = !1;
                        for (n in p) l || (m ? "hidden" in m && (g = m.hidden) : m = kt.access(t, "fxshow", {
                            display: u
                        }), o && (m.hidden = !g), g && y([t], !0), d.done(function () {
                            g || y([t]), kt.remove(t, "fxshow");
                            for (n in p) ft.style(t, n, p[n])
                        })), l = F(g ? m[n] : 0, n, d), n in m || (m[n] = l.start, g && (l.end = l.start, l.start = 0))
                    }
                }],
                ...
                stop: function (t, e, i) {
                    ...
                    return "string" != typeof t && (i = e, e = t, t = void 0), e && !1 !== t && this.queue(t || "fx", []), this.each(function () {
                        ...
                        if (r) s[r] && s[r].stop && n(s[r]);
                            ...
                            for (r in s) s[r] && s[r].stop && me.test(r) && n(s[r]);
                ...
                ft.fn[e] = function (t, n, r) {
                    return null == t || "boolean" == typeof t ? i.apply(this, arguments) : this.animate(H(e, !0), t, n, r)
                }
            }), ft.each({
                slideDown: H("show"),
                slideUp: H("hide"),
        ...
        ft.fn.extend({
            ...
            attr: function (t, e, i) {
                ...
                if (3 !== o && 8 !== o && 2 !== o) return void 0 === t.getAttribute ? ft.prop(t, e, i) : (1 === o && ft.isXMLDoc(t) || (r = ft.attrHooks[e.toLowerCase()] || (ft.expr.match.bool.test(e) ? ye : void 0)), void 0 !== i ? null === i ? void ft.removeAttr(t, e) : r && "set" in r && void 0 !== (n = r.set(t, i, e)) ? n : (t.setAttribute(e, i + ""), i) : r && "get" in r && null !== (n = r.get(t, e)) ? n : (n = ft.find.attr(t, e), null == n ? void 0 : n))
            },
            attrHooks: {
                type: {
                    set: function (t, e) {
            ...
            ve[e] = function (t, e, n) {
                ...
                return n || (o = ve[s], ve[s] = r, r = null != i(t, e, n) ? s : null, ve[s] = o), r
            }
        });
        ...
        ft.fn.extend({
            ...
            addClass: function (t) {
                ...
                if ("string" == typeof t && t)
                    for (e = t.match(At) || []; i = this[l++];)
                        if (r = q(i), n = 1 === i.nodeType && " " + $(r) + " ") {
                            for (s = 0; o = e[s++];) n.indexOf(" " + o + " ") < 0 && (n += o + " ");
                            r !== (a = $(n)) && i.setAttribute("class", a)
                        } return this
            },
            ...
            toggleClass: function (t, e) {
                ...
                return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : ft.isFunction(t) ? this.each(function (i) {
                    ...
                    var e, n, r, o;
                    if ("string" === i)
                        for (n = 0, r = ft(this), o = t.match(At) || []; e = o[n++];) r.hasClass(e) ? r.removeClass(e) : r.addClass(e);
                    else void 0 !== t && "boolean" !== i || ((e = q(this)) && kt.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === t ? "" : kt.get(this, "__className__") || ""))
                })
            },
            hasClass: function (t) {
                var e, i, n = 0;
                for (e = " " + t + " "; i = this[n++];)
                    if (1 === i.nodeType && (" " + $(q(i)) + " ").indexOf(e) > -1) return !0;
                return !1
            }
        });
        var Te = /\r/g;
        ft.fn.extend({
            val: function (t) {
                ...
                return arguments.length ? (n = ft.isFunction(t), this.each(function (i) {
                    var r;
                    1 === this.nodeType && (r = n ? t.call(this, i, ft(this).val()) : t, null == r ? r = "" : "number" == typeof r ? r += "" : Array.isArray(r) && (r = ft.map(r, function (t) {
                        return null == t ? "" : t + ""
                    })), (e = ft.valHooks[this.type] || ft.valHooks[this.nodeName.toLowerCase()]) && "set" in e && void 0 !== e.set(this, r, "value") || (this.value = r))
                })) : r ? (e = ft.valHooks[r.type] || ft.valHooks[r.nodeName.toLowerCase()], e && "get" in e && void 0 !== (i = e.get(r, "value")) ? i : (i = r.value, "string" == typeof i ? i.replace(Te, "") : null == i ? "" : i)) : void 0
            }
        }), ft.extend({
            valHooks: {
                option: {
                ...
                select: {
                    ...
                    set: function (t, e) {
                        for (var i, n, r = t.options, o = ft.makeArray(e), s = r.length; s--;) n = r[s], (n.selected = ft.inArray(ft.valHooks.option.get(n), o) > -1) && (i = !0);
        ...
        ft.extend(ft.event, {
            trigger: function (e, i, n, r) {
                var o, s, a, l, u, c, h, d = [n || et],
                    p = ut.call(e, "type") ? e.type : e,
                    f = ut.call(e, "namespace") ? e.namespace.split(".") : [];
                if (s = a = n = n || et, 3 !== n.nodeType && 8 !== n.nodeType && !we.test(p + ft.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."), p = f.shift(), f.sort()), u = p.indexOf(":") < 0 && "on" + p, e = e[ft.expando] ? e : new ft.Event(p, "object" == typeof e && e), e.isTrigger = r ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : ft.makeArray(i, [e]), h = ft.event.special[p] || {}, r || !h.trigger || !1 !== h.trigger.apply(n, i))) {
                    if (!r && !h.noBubble && !ft.isWindow(n)) {
                        for (l = h.delegateType || p, we.test(l + p) || (s = s.parentNode); s; s = s.parentNode) d.push(s), a = s;
                        a === (n.ownerDocument || et) && d.push(a.defaultView || a.parentWindow || t)
                    }
                    for (o = 0;
                        (s = d[o++]) && !e.isPropagationStopped();) e.type = o > 1 ? l : h.bindType || p, (c = (kt.get(s, "events") || {})[e.type] && kt.get(s, "handle")) && c.apply(s, i), (c = u && s[u]) && c.apply && Yt(s) && (e.result = c.apply(s, i), !1 === e.result && e.preventDefault());
                    return e.type = p, r || e.isDefaultPrevented() || h._default && !1 !== h._default.apply(d.pop(), i) || !Yt(n) || u && ft.isFunction(n[p]) && !ft.isWindow(n) && ((a = n[u]) && (n[u] = null), ft.event.triggered = p, n[p](), ft.event.triggered = void 0, a && (n[u] = a)), e.result
                }
            },
        ...
        ft.param = function (t, e) {
            ...
            serializeArray: function () {
                return this.map(function () {
                    ...
                    var t = this.type;
                    return this.name && !ft(this).is(":disabled") && Ae.test(this.nodeName) && !Ie.test(t) && (this.checked || !Bt.test(t))
                }).map(function (t, e) {
                    var i = ft(this).val();
        ...
        We.href = Ce.href, ft.extend({
            ...
            ajax: function (e, i) {
                ...
                var r, o, s, a, l, u, c, h, d, p, f = ft.ajaxSetup({}, i),
                    ...
                    C = {
                        ...
                        getResponseHeader: function (t) {
                            ...
                            if (c) {
                                if (!a)
                                    for (a = {}; e = Ye.exec(s);) a[e[1].toLowerCase()] = e[2];
                                e = a[t.toLowerCase()]
                            }
                ...
                if (y.promise(C), f.url = ((e || f.url || Ce.href) + "").replace(Ne, Ce.protocol + "//"), f.type = i.method || i.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(At) || [""], null == f.crossDomain) {
        ...
        dt.cors = !!He && "withCredentials" in He, dt.ajax = He = !!He, ft.ajaxTransport(function (e) {
            ...
            if (dt.cors || He && !e.crossDomain) return {
                send: function (r, o) {
                    ...
                    i = function (t) {
                        return function () {
                            i && (i = n = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === t ? a.abort() : "error" === t ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(Me[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                                binary: a.response
                            } : {
                                text: a.responseText
        ...
        ft.ajaxSetup({
            ...
            if (a || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = ft.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Be, "$1" + r) : !1 !== e.jsonp && (e.url += (xe.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function () {
                return s || ft.error(r + " was not called"), s[0]
            }, e.dataTypes[0] = "json", o = t[r], t[r] = function () {
                s = arguments
            }, n.always(function () {
                void 0 === o ? ft(t).removeProp(r) : t[r] = o, e[r] && (e.jsonpCallback = i.jsonpCallback, Fe.push(r)), s && ft.isFunction(o) && o(s[0]), s = o = void 0
            }), "script"
            ...
            var n, r, o;
            return e || (dt.createHTMLDocument ? (e = et.implementation.createHTMLDocument(""), n = e.createElement("base"), n.href = et.location.href, e.head.appendChild(n)) : e = et), r = Ct.exec(t), o = !i && [], r ? [e.createElement(r[1])] : (r = b([t], e, o), o && o.length && ft(o).remove(), ft.merge([], r.childNodes))
        }, ft.fn.load = function (t, e, i) {
            var n, r, o, s = this,
                a = t.indexOf(" ");
            return a > -1 && (n = $(t.slice(a)), t = t.slice(0, a)), ft.isFunction(e) ? (i = e, e = void 0) : e && "object" == typeof e && (r = "POST"), s.length > 0 && ft.ajax({
                url: t,
                type: r || "GET",
                dataType: "html",
                data: e
            ...
            setOffset: function (t, e, i) {
                var n, r, o, s, a, l, u = ft.css(t, "position"),
                    c = ft(t),
                    h = {};
                "static" === u && (t.style.position = "relative"), a = c.offset(), o = ft.css(t, "top"), l = ft.css(t, "left"), ("absolute" === u || "fixed" === u) && (o + l).indexOf("auto") > -1 ? (n = c.position(), s = n.top, r = n.left) : (s = parseFloat(o) || 0, r = parseFloat(l) || 0), ft.isFunction(e) && (e = e.call(t, i, ft.extend({}, a))), null != e.top && (h.top = e.top - a.top + s), null != e.left && (h.left = e.left - a.left + r), "using" in e ? e.using.call(t, h) : c.css(h)
            }
        }, ft.fn.extend({
            offset: function (t) {
                ...
                return o ? o.getClientRects().length ? (n = o.getBoundingClientRect(), e = o.ownerDocument, i = e.documentElement, r = e.defaultView, {
            ...
            ft.fn[t] = function (n) {
                return jt(this, function (t, n, r) {
                    var o;
                    return ft.isWindow(t) ? o = t : 9 === t.nodeType && (o = t.defaultView), void 0 === r ? o ? o[e] : t[n] : void(o ? o.scrollTo(i ? o.pageXOffset : r, i ? r : o.pageYOffset) : t[n] = r)
                }, t, n, arguments.length)
            }
        }), ft.each(["top", "left"], function (t, e) {
            ft.cssHooks[e] = Y(dt.pixelPosition, function (t, i) {
                if (i) return i = j(t, e), oe.test(i) ? ft(t).position()[e] + "px" : i
            })
        }), ft.each({
            Height: "height",
            Width: "width"
            ...
            ft.each({
                ...
                ft.fn[n] = function (r, o) {
                    var s = arguments.length && (i || "boolean" != typeof r),
                        a = i || (!0 === r || !0 === o ? "margin" : "border");
                    return jt(this, function (e, i, r) {
                        var o;
                        return ft.isWindow(e) ? 0 === n.indexOf("outer") ? e["inner" + t] : e.document.documentElement["client" + t] : 9 === e.nodeType ? (o = e.documentElement, Math.max(e.body["scroll" + t], o["scroll" + t], e.body["offset" + t], o["offset" + t], o["client" + t])) : void 0 === r ? ft.css(e, i, a) : ft.style(e, i, r, a)
                    }, e, s ? r : void 0, s)
                }
            })
        }), ft.fn.extend({
        ...
        return ft.noConflict = function (e) {
            return t.$ === ft && (t.$ = $e), e && t.jQuery === ft && (t.jQuery = Ve), ft
        }, e || (t.jQuery = t.$ = ft), ft
    }), function (t, e) {
        ...
        function o(t) {
            ...
            for (var n = t;
                ...
                if (void 0 === r || null === r) return i.push(n), i;
                var o = r,
                    s = o.overflow,
                    a = o.overflowX,
                    l = o.overflowY;
        ...
        var x = null,
            ...
            I = function () {
                var t = x;
                t || ((t = document.createElement("div")).setAttribute("data-tether-id", P()), c(t.style, {
                    top: 0,
                    left: 0,
                    position: "absolute"
                }), document.body.appendChild(t), x = t);
                var e = t.getAttribute("data-tether-id");
                return void 0 === S[e] && (S[e] = r(t), D(function () {
                    delete S[e]
                })), S[e]
            },
            A = [],
                        ...
                        if (void 0 !== this.bindings && this.bindings[t]) {
                            ...
                            for (; e < this.bindings[t].length;) {
                                var o = this.bindings[t][e],
                                    ...
                                    l = o.once,
                                    u = a;
                                void 0 === u && (u = this), s.apply(u, n), l ? this.bindings[t].splice(e, 1) : ++e
                            }
                        }
                    }
                }]), t
        ...
        ! function () {
            var t = null,
                ...
                i = null,
                n = function n() {
                    return void 0 !== e && e > 16 ? (e = Math.min(e - 16, 250), void(i = setTimeout(n, 250))) : void(void 0 !== t && _() - t < 10 || (null != i && (clearTimeout(i), i = null), t = _(), R(), e = _() - t))
                };
        ...
        var z = {
            ...
            H = function (t, e) {
                var i = t.left,
                    n = t.top;
                return "auto" === i && (i = z[e.left]), "auto" === n && (n = W[e.top]), {
                    left: i,
                    top: n
                }
            },
            F = function (t) {
                var e = t.left,
                    i = t.top;
                return void 0 !== M[t.left] && (e = M[t.left]), void 0 !== M[t.top] && (i = M[t.top]), {
                    left: e,
                    top: i
                }
            },
            ...
            $ = function (t) {
                function e(t) {
                    var i = this;
                    n(this, e), k(Object.getPrototypeOf(e.prototype), "constructor", this).call(this), this.position = this.position.bind(this), Q.push(this), this.history = [], this.setOptions(t, !1), E.modules.forEach(function (t) {
                ...
                return y(e, t), C(e, [{
                    ...
                    value: function () {
                        ...
                        if ("scroll-handle" === this.targetModifier) {
                            ...
                            var r = t.height - parseFloat(i.borderTopWidth) - parseFloat(i.borderBottomWidth) - n,
                                o = {
                                    width: 15,
                                    height: .975 * r * (r / e.scrollHeight),
                                    left: t.left + t.width - parseFloat(i.borderLeftWidth) - 15
                                },
                                s = 0;
                            408 > r && this.target === document.body && (s = -11e-5 * Math.pow(r, 2) - .00727 * r + 22.58), this.target !== document.body && (o.height = Math.max(o.height, 24));
                    ...
                    value: function () {
                        var t = this;
                        this.disable(), Q.forEach(function (e, i) {
                            e === t && Q.splice(i, 1)
                        }), 0 === Q.length && s()
                    }
                }, {
                    ...
                    value: function () {
                        ...
                        if (this.enabled) {
                            ...
                            d = b(d, f), p = b(p, g);
                            for (var m = c.left + p.left - d.left, y = c.top + p.top - d.top, v = 0; v < E.modules.length; ++v) {
                                var _ = E.modules[v].position.call(this, {
                                    left: m,
                                    top: y,
                                    targetAttachment: i,
                                    targetPos: c,
                                ...
                                if (!1 === _) return !1;
                                void 0 !== _ && "object" == typeof _ && (y = _.top, m = _.left)
                            }
                            var w = {
                                    page: {
                                        top: y,
                                ...
                                x = C.defaultView,
                                P = void 0;
                            return C.body.scrollWidth > x.innerWidth && (P = this.cache("scrollbar-size", u), w.viewport.bottom -= P.height), C.body.scrollHeight > x.innerHeight && (P = this.cache("scrollbar-size", u), w.viewport.right -= P.width), (-1 === ["", "static"].indexOf(C.body.style.position) || -1 === ["", "static"].indexOf(C.body.parentElement.style.position)) && (w.page.bottom = C.body.scrollHeight - y - o, w.page.right = C.body.scrollWidth - m - r), void 0 !== this.options.optimizations && !1 !== this.options.optimizations.moveElement && void 0 === this.targetModifier && function () {
                                ...
                                if (["Top", "Left", "Bottom", "Right"].forEach(function (t) {
                                    ...
                                    w.offset = {
                                        ...
                                        left: w.page.left - i.left + u - o.left
                                    }
                                }
                    ...
                    value: function (t) {
                        ...
                        if (void 0 !== this.element.parentNode) {
                            ...
                            var u = {
                                ...
                                h = function (t, i) {
                                    if (!1 !== (void 0 !== e.options.optimizations ? e.options.optimizations.gpu : null)) {
                                        var n = void 0,
                                            r = void 0;
                                        t.top ? (u.top = 0, n = i.top) : (u.bottom = 0, n = -i.bottom), t.left ? (u.left = 0, r = i.left) : (u.right = 0, r = -i.right), u[N] = "translateX(" + Math.round(r) + "px) translateY(" + Math.round(n) + "px)", "msTransform" !== N && (u[N] += " translateZ(0)")
                                    } else t.top ? u.top = i.top + "px" : u.bottom = i.bottom + "px", t.left ? u.left = i.left + "px" : u.right = i.right + "px"
                                },
                                d = !1;
                            if ((i.page.top || i.page.bottom) && (i.page.left || i.page.right) ? (u.position = "absolute", h(i.page, t.page)) : (i.viewport.top || i.viewport.bottom) && (i.viewport.left || i.viewport.right) ? (u.position = "fixed", h(i.viewport, t.viewport)) : void 0 !== i.offset && i.offset.top && i.offset.left ? function () {
                                    u.position = "absolute";
                            ...
                            for (var r in u) {
                                var y = u[r];
                                this.element.style[r] !== y && (m = !0, g[r] = y)
                            }
                            m && D(function () {
                                c(e.element.style, g)
                            })
        ...
        E.modules.push({
            position: function (t) {
                ...
                return this.options.constraints.forEach(function (t) {
                    ...
                    var _ = w(e, o);
                    ("target" === h || "both" === h) && (i < _[1] && "top" === y.top && (i += d, y.top = "bottom"), i + s > _[3] && "bottom" === y.top && (i -= d, y.top = "top")), "together" === h && ("top" === y.top && ("bottom" === v.top && i < _[1] ? (i += d, y.top = "bottom", i += s, v.top = "top") : "top" === v.top && i + s > _[3] && i - (s - d) >= _[1] && (i -= s - d, y.top = "bottom", v.top = "bottom")), "bottom" === y.top && ("top" === v.top && i + s > _[3] ? (i -= d, y.top = "top", i -= s, v.top = "bottom") : "bottom" === v.top && i < _[1] && i + (2 * s - d) <= _[3] && (i += s - d, y.top = "top", v.top = "top")), "middle" === y.top && (i + s > _[3] && "top" === v.top ? (i -= s, v.top = "bottom") : i < _[1] && "bottom" === v.top && (i += s, v.top = "top"))), ("target" === c || "both" === c) && (n < _[0] && "left" === y.left && (n += p, y.left = "right"), n + l > _[2] && "right" === y.left && (n -= p, y.left = "left")), "together" === c && (n < _[0] && "left" === y.left ? "right" === v.left ? (n += p, y.left = "right", n += l, v.left = "left") : "left" === v.left && (n += p, y.left = "right", n -= l, v.left = "right") : n + l > _[2] && "right" === y.left ? "left" === v.left ? (n -= p, y.left = "left", n -= l, v.left = "right") : "right" === v.left && (n -= p, y.left = "left", n += l, v.left = "left") : "center" === y.left && (n + l > _[2] && "left" === v.left ? (n -= l, v.left = "right") : n < _[0] && "right" === v.left && (n += l, v.left = "left"))), ("element" === h || "both" === h) && (i < _[1] && "bottom" === v.top && (i += s, v.top = "top"), i + s > _[3] && "top" === v.top && (i -= s, v.top = "bottom")), ("element" === c || "both" === c) && (n < _[0] && ("right" === v.left ? (n += l, v.left = "left") : "center" === v.left && (n += l / 2, v.left = "left")), n + l > _[2] && ("left" === v.left ? (n -= l, v.left = "right") : "center" === v.left && (n -= l / 2, v.left = "right"))), "string" == typeof u ? u = u.split(",").map(function (t) {
                        return t.trim()
                    }) : !0 === u && (u = ["top", "left", "right", "bottom"]), u = u || [];
                    var b = [],
                        T = [];
                    i < _[1] && (u.indexOf("top") >= 0 ? (i = _[1], b.push("top")) : T.push("top")), i + s > _[3] && (u.indexOf("bottom") >= 0 ? (i = _[3] - s, b.push("bottom")) : T.push("bottom")), n < _[0] && (u.indexOf("left") >= 0 ? (n = _[0], b.push("left")) : T.push("left")), n + l > _[2] && (u.indexOf("right") >= 0 ? (n = _[2] - l, b.push("right")) : T.push("right")), b.length && function () {
                        var t = void 0;
                        ...
                        var t = void 0;
                        t = void 0 !== e.options.outOfBoundsClass ? e.options.outOfBoundsClass : e.getClass("out-of-bounds"), g.push(t), T.forEach(function (e) {
                            g.push(t + "-" + e)
                        })
                    }(), (b.indexOf("left") >= 0 || b.indexOf("right") >= 0) && (v.left = y.left = !1), (b.indexOf("top") >= 0 || b.indexOf("bottom") >= 0) && (v.top = y.top = !1), (y.top !== r.top || y.left !== r.left || v.top !== e.attachment.top || v.left !== e.attachment.left) && (e.updateAttachClasses(v, y), e.trigger("update", {
                        attachment: v,
                        targetAttachment: y
                    }))
                }), D(function () {
...
function () {
    ...
    var n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
        ...
        o = function (t) {
            ...
            return s = r(), t.fn.emulateTransitionEnd = o, l.supportsTransitionEnd() && (t.event.special[l.TRANSITION_END] = n()), l
        }(jQuery),
        s = (function (t) {
            var e = "alert",
                n = "bs.alert",
                ...
                h = function () {
                    ...
                    return e.prototype.close = function (t) {
                        ...
                        var i = this;
                        return t(e).removeClass(c.SHOW), o.supportsTransitionEnd() && t(e).hasClass(c.FADE) ? void t(e).one(o.TRANSITION_END, function (t) {
                        ...
                        return this.each(function () {
                            var r = t(this),
                                o = r.data(n);
                            o || (o = new e(this), r.data(n, o)), "close" === i && o[i](this)
                        })
            ...
            t(document).on(u.CLICK_DATA_API, l.DISMISS, h._handleDismiss(new h)), t.fn[e] = h._jQueryInterface, t.fn[e].Constructor = h, t.fn[e].noConflict = function () {
            ...
            var e = "button",
                ...
                h = function () {
                    ...
                    return e.prototype.toggle = function () {
                        ...
                        return this.each(function () {
                            var r = t(this).data(n);
                            r || (r = new e(this), t(this).data(n, r)), "toggle" === i && r[i]()
                        })
                    }, r(e, null, [{
                        key: "VERSION",
                        get: function () {
            ...
            t(document).on(c.CLICK_DATA_API, u.DATA_TOGGLE_CARROT, function (e) {
                e.preventDefault();
                var i = e.target;
                t(i).hasClass(l.BUTTON) || (i = t(i).closest(u.BUTTON)), h._jQueryInterface.call(t(i), "toggle")
            ...
            var e = "carousel",
                ...
                m = function () {
                    ...
                    return l.prototype.next = function () {
                        ...
                        e || (this._isPaused = !0), t(this._element).find(g.NEXT_PREV)[0] && o.supportsTransitionEnd() && (o.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
                        ...
                        if (!(e > this._items.length - 1 || e < 0)) {
                            ...
                            var r = e > n ? d.NEXT : d.PREVIOUS;
                            this._slide(r, this._items[e])
                        }
                    }, l.prototype.dispose = function () {
                        t(this._element).off(a), t.removeData(this._element, s), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
                    }, l.prototype._getConfig = function (i) {
                        return i = t.extend({}, c, i), o.typeCheckConfig(e, i, h), i
                        ...
                        var s = (r + (t === d.PREVIOUS ? -1 : 1)) % this._items.length;
                        ...
                        var n = this,
                            ...
                            u = void 0,
                            c = void 0;
                        if (e === d.NEXT ? (l = f.LEFT, u = f.NEXT, c = d.LEFT) : (l = f.RIGHT, u = f.PREV, c = d.RIGHT), s && t(s).hasClass(f.ACTIVE)) this._isSliding = !1;
                        else if (!this._triggerSlideEvent(s, c).isDefaultPrevented() && r && s) {
                            this._isSliding = !0, a && this.pause(), this._setActiveIndicatorElement(s);
                            var h = t.Event(p.SLID, {
                                relatedTarget: s,
                                direction: c
                            });
                            o.supportsTransitionEnd() && t(this._element).hasClass(f.SLIDE) ? (t(s).addClass(u), o.reflow(s), t(r).addClass(l), t(s).addClass(l), t(r).one(o.TRANSITION_END, function () {
                                t(s).removeClass(l + " " + u).addClass(f.ACTIVE), t(r).removeClass(f.ACTIVE + " " + u + " " + l), n._isSliding = !1, setTimeout(function () {
                                    return t(n._element).trigger(h)
                                }, 0)
                            }).emulateTransitionEnd(600)) : (t(r).removeClass(f.ACTIVE), t(s).addClass(f.ACTIVE), this._isSliding = !1, t(this._element).trigger(h)), a && this.cycle()
                        }
                    }, l._jQueryInterface = function (e) {
                        return this.each(function () {
                            var i = t(this).data(s),
                                r = t.extend({}, c, t(this).data());
                            "object" === (void 0 === e ? "undefined" : n(e)) && t.extend(r, e);
                            var o = "string" == typeof e ? e : r.slide;
                            if (i || (i = new l(this, r), t(this).data(s, i)), "number" == typeof e) i.to(e);
                        ...
                        if (i) {
                            ...
                            if (n && t(n).hasClass(f.CAROUSEL)) {
                                ...
                                a && (r.interval = !1), l._jQueryInterface.call(t(n), r), a && t(n).data(s).to(a), e.preventDefault()
                            }
                        }
                    }, r(l, null, [{
                        key: "VERSION",
                ...
                g = function () {
                    ...
                    return a.prototype.toggle = function () {
                        ...
                        if (!t(this._element).hasClass(d.SHOW)) {
                            var i = void 0,
                                n = void 0;
                            if (this._parent && ((i = t.makeArray(t(this._parent).find(f.ACTIVES))).length || (i = null)), !(i && (n = t(i).data(s)) && n._isTransitioning)) {
                                ...
                                if (t(this._element).trigger(r), !r.isDefaultPrevented()) {
                                    ...
                                    t(this._element).one(o.TRANSITION_END, u).emulateTransitionEnd(600), this._element.style[l] = this._element[c] + "px"
                                }
                            }
                        }
                        ...
                        if (t(this._element).hasClass(d.SHOW)) {
                            ...
                            if (t(this._element).trigger(i), !i.isDefaultPrevented()) {
                                var n = this._getDimension(),
                                    r = n === p.WIDTH ? "offsetWidth" : "offsetHeight";
                                this._element.style[n] = this._element[r] + "px", o.reflow(this._element), t(this._element).addClass(d.COLLAPSING).removeClass(d.COLLAPSE).removeClass(d.SHOW), this._element.setAttribute("aria-expanded", !1), this._triggerArray.length && t(this._triggerArray).addClass(d.COLLAPSED).attr("aria-expanded", !1), this.setTransitioning(!0);
                                var s = function () {
                                    e.setTransitioning(!1), t(e._element).removeClass(d.COLLAPSING).addClass(d.COLLAPSE).trigger(h.HIDDEN)
                                };
                                return this._element.style[n] = "", o.supportsTransitionEnd() ? void t(this._element).one(o.TRANSITION_END, s).emulateTransitionEnd(600) : void s()
                            }
                        }
                        ...
                        return i = t.extend({}, u, i), i.toggle = Boolean(i.toggle), o.typeCheckConfig(e, i, c), i
                        ...
                        return this.each(function () {
                            var i = t(this),
                                r = i.data(s),
                                o = t.extend({}, u, i.data(), "object" === (void 0 === e ? "undefined" : n(e)) && e);
                            if (!r && o.toggle && /show|hide/.test(e) && (o.toggle = !1), r || (r = new a(this, o), i.data(s, r)), "string" == typeof e) {
                ...
                d = function () {
                    ...
                    return e.prototype.toggle = function () {
                        ...
                        var o = {
                            ...
                            s = t.Event(u.SHOW, o);
                        return t(i).trigger(s), !s.isDefaultPrevented() && (this.focus(), this.setAttribute("aria-expanded", !0), t(i).toggleClass(c.SHOW), t(i).trigger(t.Event(u.SHOWN, o)), !1)
                    }, e.prototype.dispose = function () {
                        ...
                        return this.each(function () {
                            var r = t(this).data(n);
                            if (r || (r = new e(this), t(this).data(n, r)), "string" == typeof i) {
                        ...
                        if (!i || 3 !== i.which) {
                            ...
                            for (var r = t.makeArray(t(h.DATA_TOGGLE)), o = 0; o < r.length; o++) {
                                var s = e._getParentFromElement(r[o]),
                                    a = {
                                        relatedTarget: r[o]
                                    };
                                if (t(s).hasClass(c.SHOW) && !(i && ("click" === i.type && /input|textarea/i.test(i.target.tagName) || "focusin" === i.type) && t.contains(s, i.target))) {
                                    var l = t.Event(u.HIDE, a);
                                    t(s).trigger(l), l.isDefaultPrevented() || (r[o].setAttribute("aria-expanded", "false"), t(s).removeClass(c.SHOW).trigger(t.Event(u.HIDDEN, a)))
                                }
                            }
                        }
                        ...
                        if (/(38|40|27|32)/.test(i.which) && !/input|textarea/i.test(i.target.tagName) && (i.preventDefault(), i.stopPropagation(), !this.disabled && !t(this).hasClass(c.DISABLED))) {
                            var n = e._getParentFromElement(this),
                                r = t(n).hasClass(c.SHOW);
            ...
            var e = "modal",
                ...
                f = function () {
                    ...
                    return l.prototype.toggle = function (t) {
                        ...
                        t.removeData(this._element, s), t(window, document, this._element, this._backdrop).off(a), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._originalBodyPadding = null, this._scrollbarWidth = null
                    }, l.prototype._getConfig = function (i) {
                        return i = t.extend({}, u, i), o.typeCheckConfig(e, i, c), i
                        ...
                        var r = t.Event(h.SHOWN, {
                                relatedTarget: e
                            }),
                            s = function () {
                                i._config.focus && i._element.focus(), i._isTransitioning = !1, t(i._element).trigger(r)
                            };
                        n ? t(this._dialog).one(o.TRANSITION_END, s).emulateTransitionEnd(300) : s()
                        ...
                        if (this._isShown && this._config.backdrop) {
                            ...
                            if (this._backdrop = document.createElement("div"), this._backdrop.className = d.BACKDROP, n && t(this._backdrop).addClass(n), t(this._backdrop).appendTo(document.body), t(this._element).on(h.CLICK_DISMISS, function (t) {
                                ...
                                }), r && o.reflow(this._backdrop), t(this._backdrop).addClass(d.SHOW), !e) return;
                            if (!r) return void e();
                        ...
                        return this.each(function () {
                            var r = t(this).data(s),
                                o = t.extend({}, l.Default, t(this).data(), "object" === (void 0 === e ? "undefined" : n(e)) && e);
                ...
                g = function () {
                    ...
                    return l.prototype.refresh = function () {
                        var e = this,
                            ...
                            r = n === f.POSITION ? this._getScrollTop() : 0;
                        ...
                        if ("string" != typeof (i = t.extend({}, u, i)).target) {
                            var n = t(i.target).attr("id");
                            n || (n = o.getUID(e), t(i.target).attr("id", n)), i.target = "#" + n
                        }
                        return o.typeCheckConfig(e, i, c), i
                        ...
                        var n = t(i.join(","));
                        n.hasClass(d.DROPDOWN_ITEM) ? (n.closest(p.DROPDOWN).find(p.DROPDOWN_TOGGLE).addClass(d.ACTIVE), n.addClass(d.ACTIVE)) : n.parents(p.LI).find("> " + p.NAV_LINKS).addClass(d.ACTIVE), t(this._scrollElement).trigger(h.ACTIVATE, {
                            relatedTarget: e
                        })
                        ...
                        return this.each(function () {
                            var i = t(this).data(s),
                                r = "object" === (void 0 === e ? "undefined" : n(e)) && e;
                            if (i || (i = new l(this, r), t(this).data(s, i)), "string" == typeof e) {
                ...
                h = function () {
                    ...
                    return e.prototype.show = function () {
                        ...
                        if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(u.ACTIVE) || t(this._element).hasClass(u.DISABLED))) {
                            var i = void 0,
                                n = void 0,
                                r = t(this._element).closest(c.LIST)[0],
                                s = o.getSelectorFromElement(this._element);
                            r && (n = t.makeArray(t(r).find(c.ACTIVE)), n = n[n.length - 1]);
                            ...
                            if (n && t(n).trigger(a), t(this._element).trigger(h), !h.isDefaultPrevented() && !a.isDefaultPrevented()) {
                        ...
                        var r = this,
                            s = t(i).find(c.ACTIVE_CHILD)[0],
                            a = n && o.supportsTransitionEnd() && (s && t(s).hasClass(u.FADE) || Boolean(t(i).find(c.FADE_CHILD)[0])),
                            l = function () {
                                return r._transitionComplete(e, s, a, n)
                            };
                        s && a ? t(s).one(o.TRANSITION_END, l).emulateTransitionEnd(150) : l(), s && t(s).removeClass(u.SHOW)
                    }, e.prototype._transitionComplete = function (e, i, n, r) {
                        if (i) {
                            t(i).removeClass(u.ACTIVE);
                            var s = t(i.parentNode).find(c.DROPDOWN_ACTIVE_CHILD)[0];
                            s && t(s).removeClass(u.ACTIVE), i.setAttribute("aria-expanded", !1)
                        }
                        if (t(e).addClass(u.ACTIVE), e.setAttribute("aria-expanded", !0), n ? (o.reflow(e), t(e).addClass(u.SHOW)) : t(e).removeClass(u.FADE), e.parentNode && t(e.parentNode).hasClass(u.DROPDOWN_MENU)) {
                        ...
                        return this.each(function () {
                            var r = t(this),
                                o = r.data(n);
                            if (o || (o = new e(this), r.data(n, o)), "string" == typeof i) {
                ...
                v = function () {
                    ...
                    return l.prototype.enable = function () {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            r.setAttribute("id", s), this.element.setAttribute("aria-describedby", s), this.setContent(), this.config.animation && t(r).addClass(f.FADE);
                            var a = "function" == typeof this.config.placement ? this.config.placement.call(this, r, this.element) : this.config.placement,
                                u = this._getAttachment(a),
                                c = !1 === this.config.container ? document.body : t(this.config.container);
                            t(r).data(this.constructor.DATA_KEY, this).appendTo(c), t(this.element).trigger(this.constructor.Event.INSERTED), this._tether = new Tether({
                                attachment: u,
                                element: r,
                                target: this.element,
                                classes: m,
                                ...
                                addTargetClasses: !1
                            }), o.reflow(r), this._tether.position(), t(r).addClass(f.SHOW);
                            var h = function () {
                                var i = e._hoverState;
                                e._hoverState = null, e._isTransitioning = !1, t(e.element).trigger(e.constructor.Event.SHOWN), i === d.OUT && e._leave(null, e)
                            };
                            if (o.supportsTransitionEnd() && t(this.tip).hasClass(f.FADE)) return this._isTransitioning = !0, void t(this.tip).one(o.TRANSITION_END, h).emulateTransitionEnd(l._TRANSITION_DURATION);
                            h()
                        }
                    }, l.prototype.hide = function (e) {
                        var i = this,
                        ...
                        t(this.element).trigger(r), r.isDefaultPrevented() || (t(n).removeClass(f.SHOW), this._activeTrigger[y.CLICK] = !1, this._activeTrigger[y.FOCUS] = !1, this._activeTrigger[y.HOVER] = !1, o.supportsTransitionEnd() && t(this.tip).hasClass(f.FADE) ? (this._isTransitioning = !0, t(n).one(o.TRANSITION_END, s).emulateTransitionEnd(150)) : s(), this._hoverState = "")
                        ...
                        "object" === (void 0 === i ? "undefined" : n(i)) && (i.nodeType || i.jquery) ? r ? t(i).parent().is(e) || e.empty().append(i) : e.text(t(i).text()): e[r ? "html" : "text"](i)
                        ...
                        this.config.trigger.split(" ").forEach(function (i) {
                            if ("click" === i) t(e.element).on(e.constructor.Event.CLICK, e.config.selector, function (t) {
                                ...
                                var n = i === y.HOVER ? e.constructor.Event.MOUSEENTER : e.constructor.Event.FOCUSIN,
                                    r = i === y.HOVER ? e.constructor.Event.MOUSELEAVE : e.constructor.Event.FOCUSOUT;
                        ...
                        return this.each(function () {
                            var i = t(this).data(s),
                                r = "object" === (void 0 === e ? "undefined" : n(e)) && e;
                            if ((i || !/dispose|hide/.test(e)) && (i || (i = new l(this, r), t(this).data(s, i)), "string" == typeof e)) {
                                if (void 0 === i[e]) throw new Error('No method named "' + e + '"');
                                i[e]()
                            }
                        })
            ...
            m = function (s) {
                ...
                return e(c, s), c.prototype.isWithContent = function () {
                    ...
                    return this.each(function () {
                        ...
                        if ((e || !/destroy|hide/.test(t)) && (e || (e = new c(this, i), o(this).data(l, e)), "string" == typeof t)) {
...
function (t, e, i, n) {
    ...
    r.Defaults = {
        ...
        var i = this.current(),
            ...
            a = this.minimum(),
            l = this.maximum();
        this.settings.loop ? (!this.settings.rewind && Math.abs(r) > s / 2 && (r += -1 * o * s), t = i + r, (n = ((t - a) % s + s) % s + a) !== t && n - r <= l && n - r > 0 && (i = n - r, t = n, this.reset(i))) : this.settings.rewind ? (l += 1, t = (t % l + l) % l) : t = Math.max(a, Math.min(l, t)), this.speed(this.duration(i, t, e)), this.current(t), this.$element.is(":visible") && this.update()
...
function (t, e, i, n) {
    ...
    r.Defaults = {
        ...
        if (e.wrap('<div class="owl-video-wrapper"' + s + "></div>"), this._core.settings.lazyLoad && (l = "data-src", u = "owl-lazy"), a.length) return h(a.attr(l)), a.remove(), !1;
        "youtube" === i.type ? (o = "//img.youtube.com/vi/" + i.id + "/hqdefault.jpg", h(o)) : "vimeo" === i.type ? t.ajax({
            type: "GET",
...
function (t, e) {
    ...
    function i(i, o, a) {
        ...
        function u(t, e) {
            ...
            return "string" == typeof t ? l(this, t, r.call(arguments, 1)) : (u(this, t), this)
        }, n(a))
    }
...
function (t, e) {
    ...
    function n() {
        if (!u) {
            ...
            n.appendChild(e);
            var s = i(e);
            r.isBoxSizeOuter = o = 200 == t(s.width), n.removeChild(e)
        }
    }
    ...
    function r(r) {
        if (n(), "string" == typeof r && (r = document.querySelector(r)), r && "object" == typeof r && r.nodeType) {
            ...
            for (var c = u.isBorderBox = "border-box" == s.boxSizing, h = 0; l > h; h++) {
                var d = a[h],
                    p = s[d],
                    f = parseFloat(p);
                u[d] = isNaN(f) ? 0 : f
            ...
            var g = u.paddingLeft + u.paddingRight,
                ...
                T = c && o,
                w = t(s.width);
            !1 !== w && (u.width = w + (T ? 0 : g + _));
            var C = t(s.height);
            return !1 !== C && (u.height = C + (T ? 0 : m + b)), u.innerWidth = u.width - (g + _), u.innerHeight = u.height - (m + b), u.outerWidth = u.width + y, u.outerHeight = u.height + v, u
        }
    }
...
function (t, e) {
    ...
    return i.compatOptions.fitWidth = "isFitWidth", i.prototype._resetLayout = function () {
        ...
        for (var l = (this._getOption("originTop") ? n.top : n.bottom) + i.outerHeight, u = s; a >= u; u++) this.colYs[u] = Math.max(l, this.colYs[u])
...
! function (jQuery, ytp) {
    ...
    jQuery.browser.android = /Android/i.test(nAgt), jQuery.browser.blackberry = /BlackBerry|BB|PlayBook/i.test(nAgt), jQuery.browser.ios = /iPhone|iPad|iPod|webOS/i.test(nAgt), jQuery.browser.operaMobile = /Opera Mini/i.test(nAgt), jQuery.browser.kindle = /Kindle|Silk/i.test(nAgt), jQuery.browser.windowsMobile = /IEMobile|Windows Phone/i.test(nAgt), jQuery.browser.mobile = jQuery.browser.android || jQuery.browser.blackberry || jQuery.browser.ios || jQuery.browser.windowsMobile || jQuery.browser.operaMobile || jQuery.browser.kindle, jQuery.fn.CSSAnimate = function (t, e, i, n, r) {
        ...
        return jQuery.support.CSStransition = function () {
            ...
            if (a.CSSAIsRunning && a.eventType == u.type) a.CSSqueue = function () {
                l.CSSAnimate(t, e, i, n, r)
            };
            else if (a.CSSqueue = null, a.eventType = u.type, 0 !== l.length && t) {
                if (a.CSSAIsRunning = !0, "function" == typeof e && (r = e, e = jQuery.fx.speeds._default), "function" == typeof i && (r = i, i = 0), "function" == typeof n && (r = n, n = "cubic-bezier(0.65,0.03,0.36,0.72)"), "string" == typeof e)
                ...
                if (e || (e = jQuery.fx.speeds._default), jQuery.support.CSStransition) {
                    ...
                    var h = "",
                        d = "transitionEnd";
                    jQuery.browser.webkit ? (h = "-webkit-", d = "webkitTransitionEnd") : jQuery.browser.mozilla ? (h = "-moz-", d = "transitionend") : jQuery.browser.opera ? (h = "-o-", d = "otransitionend") : jQuery.browser.msie && (h = "-ms-", d = "msTransitionEnd"), u = [];
                    for (p in t) "transform" === (c = p) && (c = h + "transform", t[c] = t[p], delete t[p]), "filter" === c && (c = h + "filter", t[c] = t[p], delete t[p]), ("transform-origin" === c || "origin" === c) && (c = h + "transform-origin", t[c] = t[p], delete t[p]), "x" === c && (c = h + "transform", t[c] = t[c] || "", t[c] += " translateX(" + s(t[p], "px") + ")", delete t[p]), "y" === c && (c = h + "transform", t[c] = t[c] || "", t[c] += " translateY(" + s(t[p], "px") + ")", delete t[p]), "z" === c && (c = h + "transform", t[c] = t[c] || "", t[c] += " translateZ(" + s(t[p], "px") + ")", delete t[p]), "rotate" === c && (c = h + "transform", t[c] = t[c] || "", t[c] += " rotate(" + s(t[p], "deg") + ")", delete t[p]), "rotateX" === c && (c = h + "transform", t[c] = t[c] || "", t[c] += " rotateX(" + s(t[p], "deg") + ")", delete t[p]), "rotateY" === c && (c = h + "transform", t[c] = t[c] || "", t[c] += " rotateY(" + s(t[p], "deg") + ")", delete t[p]), "rotateZ" === c && (c = h + "transform", t[c] = t[c] || "", t[c] += " rotateZ(" + s(t[p], "deg") + ")", delete t[p]), "scale" === c && (c = h + "transform", t[c] = t[c] || "", t[c] += " scale(" + s(t[p], "") + ")", delete t[p]), "scaleX" === c && (c = h + "transform", t[c] = t[c] || "", t[c] += " scaleX(" + s(t[p], "") + ")", delete t[p]), "scaleY" === c && (c = h + "transform", t[c] = t[c] || "", t[c] += " scaleY(" + s(t[p], "") + ")", delete t[p]), "scaleZ" === c && (c = h + "transform", t[c] = t[c] || "", t[c] += " scaleZ(" + s(t[p], "") + ")", delete t[p]), "skew" === c && (c = h + "transform", t[c] = t[c] || "", t[c] += " skew(" + s(t[p], "deg") + ")", delete t[p]), "skewX" === c && (c = h + "transform", t[c] = t[c] || "", t[c] += " skewX(" + s(t[p], "deg") + ")", delete t[p]), "skewY" === c && (c = h + "transform", t[c] = t[c] || "", t[c] += " skewY(" + s(t[p], "deg") + ")", delete t[p]), "perspective" === c && (c = h + "transform", t[c] = t[c] || "", t[c] += " perspective(" + s(t[p], "px") + ")", delete t[p]), 0 > u.indexOf(c) && u.push(o(c));
                    var p = u.join(","),
                        f = function () {
                            l.off(d + "." + a.id), clearTimeout(a.timeout), l.css(h + "transition", ""), "function" == typeof r && r(l), a.called = !0, a.CSSAIsRunning = !1, "function" == typeof a.CSSqueue && (a.CSSqueue(), a.CSSqueue = null)
                        },
                        g = {};
                    jQuery.extend(g, t), g[h + "transition-property"] = p, g[h + "transition-duration"] = e + "ms", g[h + "transition-delay"] = i + "ms", g[h + "transition-style"] = "preserve-3d", g[h + "transition-timing-function"] = n, setTimeout(function () {
                        l.one(d + "." + a.id, f), l.css(g)
                    }, 1), a.timeout = setTimeout(function () {
                        l.called || !r ? (l.called = !1, a.CSSAIsRunning = !1) : (l.css(h + "transition", ""), r(l), a.CSSAIsRunning = !1, "function" == typeof a.CSSqueue && (a.CSSqueue(), a.CSSqueue = null))
                    }, e + i + 100)
                } else {
                    for (var p in t) "transform" === p && delete t[p], "filter" === p && delete t[p], "transform-origin" === p && delete t[p], "auto" === t[p] && delete t[p];
    ...
    ytp.isDevice = jQuery.browser.mobile, jQuery.mbYTPlayer = {
        ...
        buildPlayer: function (options) {
            return this.each(function () {
                ...
                void 0 !== property && void 0 !== property.vol && (property.vol = 0 == property.vol ? property.vol = 1 : property.vol), jQuery.extend(YTPlayer.opt, jQuery.mbYTPlayer.defaults, options, property);
                ...
                if (YTPlayer.isSelf = "self" == YTPlayer.opt.containment, YTPlayer.opt.containment = jQuery("self" == YTPlayer.opt.containment ? this : YTPlayer.opt.containment), YTPlayer.isBackground = "body" == YTPlayer.opt.containment.get(0).tagName.toLowerCase(), !YTPlayer.isBackground || !ytp.backgroundIsInited) {
                    ...
                    } else overlay.removeClass(function (t, e) {
                        var i = e.split(" "),
                            n = [];
                    ...
                    jQuery(document).on("YTAPIReady", function () {
                        ...
                        }), YTPlayer.isBackground && (ytp.backgroundIsInited = !0), YTPlayer.opt.autoPlay = void 0 === YTPlayer.opt.autoPlay ? !!YTPlayer.isBackground : YTPlayer.opt.autoPlay, YTPlayer.opt.vol = YTPlayer.opt.vol ? YTPlayer.opt.vol : 100, jQuery.mbYTPlayer.getDataFromFeed(YTPlayer), jQuery(YTPlayer).on("YTPChanged", function () {
        ...
        getDataFromFeed: function (t) {
            jQuery.browser.msie && jQuery.browser.version < 9 ? ("auto" == t.opt.ratio ? t.opt.ratio = "16/9" : t.opt.ratio, t.hasData || (t.hasData = !0, setTimeout(function () {
                jQuery(t).trigger("YTPChanged")
            }, 100))) : (jQuery.getJSON(jQuery.mbYTPlayer.locationProtocol + "//gdata.youtube.com/feeds/api/videos/" + t.videoID + "?v=2&alt=jsonc", function (e) {
                t.dataReceived = !0, t.videoData = e.data, jQuery(t).trigger("YTPChanged");
                var i = jQuery.Event("YTPData");
                i.prop = {};
                for (var n in t.videoData) i.prop[n] = t.videoData[n];
                if (jQuery(t).trigger(i), t.title = t.videoData.title, "auto" == t.opt.ratio && (t.opt.ratio = t.videoData.aspectRatio && "widescreen" === t.videoData.aspectRatio ? "16/9" : "4/3"), !t.hasData && (t.hasData = !0, t.isPlayer)) {
                ...
                t.dataReceived || t.hasData || (t.hasData = !0, jQuery(t).trigger("YTPChanged"))
            }, 1500))
        },
        ...
        playNext: function () {
            var t = this.get(0);
            ++t.videoCounter >= t.videoLength && (t.videoCounter = 0), jQuery(t.playerEl).css({
                opacity: 0
            }), jQuery(t).changeMovie(t.videos[t.videoCounter])
        },
        playPrev: function () {
            var t = this.get(0);
            --t.videoCounter < 0 && (t.videoCounter = t.videoLength - 1), jQuery(t.playerEl).css({
                opacity: 0
            }), jQuery(t).changeMovie(t.videos[t.videoCounter])
        },
        changeMovie: function (t) {
            var e = this.get(0);
            e.opt.startAt = 0, e.opt.stopAt = 0, e.opt.mute = !0, t && jQuery.extend(e.opt, t), e.videoID = getYTPVideoID(e.opt.videoURL).videoID, jQuery(e).pauseYTP();
            var i = jQuery.browser.msie ? 1e3 : 0;
            if (jQuery(e.playerEl).CSSAnimate({
                    opacity: 0
                }, i), setTimeout(function () {
                    var t = jQuery.browser.chrome ? "default" : e.opt.quality;
                    jQuery(e).getPlayer().cueVideoByUrl(encodeURI(jQuery.mbYTPlayer.locationProtocol + "//www.youtube.com/v/" + e.videoID), 1, t), jQuery(e).playYTP(), jQuery(e).one("YTPStart", function () {
                        e.wrapper.CSSAnimate({
                            opacity: e.isAlone ? 1 : e.opt.opacity
                        }, 1e3), jQuery(e.playerEl).CSSAnimate({
                            opacity: 1
                        }, i), e.opt.startAt && e.player.seekTo(e.opt.startAt), jQuery.mbYTPlayer.checkForState(e), e.opt.autoPlay || jQuery(e).pauseYTP()
            ...
            jQuery("#controlBar_" + e.id).remove(), e.opt.showControls && jQuery(e).buildYTPControls(), jQuery.mbYTPlayer.getDataFromFeed(e), jQuery(e).optimizeDisplay()
        },
        getPlayer: function () {
        ...
        playerDestroy: function () {
            var t = this.get(0);
            ytp.YTAPIReady = !1, ytp.backgroundIsInited = !1, t.isInit = !1, t.videoID = null, t.wrapper.remove(), jQuery("#controlBar_" + t.id).remove()
        },
        fullscreen: function (real) {
            function RunPrefixMethod(t, e) {
                for (var i, n, r = ["webkit", "moz", "ms", "o", ""], o = 0; o < r.length && !t[i];) {
                    if (i = e, "" == r[o] && (i = i.substr(0, 1).toLowerCase() + i.substr(1)), i = r[o] + i, "undefined" != (n = typeof t[i])) return r = [r[o]], "function" == n ? t[i]() : t[i];
                    o++
                }
            }
            ...
            if (real) {
                ...
                jQuery(document).off(fullscreenchange).on(fullscreenchange, function () {
                    RunPrefixMethod(document, "IsFullScreen") || RunPrefixMethod(document, "FullScreen") ? (jQuery(YTPlayer).setVideoQuality("default"), jQuery(YTPlayer).trigger("YTPFullScreenStart")) : (YTPlayer.isAlone = !1, fullScreenBtn.html(jQuery.mbYTPlayer.controls.onlyYT), jQuery(YTPlayer).setVideoQuality(YTPlayer.opt.quality), videoWrapper.removeClass("fullscreen"), videoWrapper.CSSAnimate({
                        opacity: YTPlayer.opt.opacity
        ...
        playYTP: function () {
            var t = this.get(0);
            void 0 !== t.player && (jQuery("#controlBar_" + t.id).find(".mb_YTVPPlaypause").html(jQuery.mbYTPlayer.controls.pause), t.player.playVideo(), jQuery(t).on("YTPStart", function () {
        ...
        stopYTP: function () {
            var t = this.get(0);
            jQuery("#controlBar_" + t.id).find(".mb_YTVPPlaypause").html(jQuery.mbYTPlayer.controls.play), t.player.stopVideo()
        },
        pauseYTP: function () {
            var t = this.get(0);
            t.opt, jQuery("#controlBar_" + t.id).find(".mb_YTVPPlaypause").html(jQuery.mbYTPlayer.controls.play), t.player.pauseVideo()
        },
        ...
        setYTPVolume: function (t) {
            var e = this.get(0);
            t || e.opt.vol || 0 != e.player.getVolume() ? !t && e.player.getVolume() > 0 || t && e.player.getVolume() == t ? jQuery(e).muteYTPVolume() : e.opt.vol = t : jQuery(e).unmuteYTP(), e.player.setVolume(e.opt.vol)
        },
        muteYTP: function () {
            var t = this.get(0);
            t.player.mute(), t.player.setVolume(0), jQuery("#controlBar_" + t.id).find(".mb_YTVPMuteUnmute").html(jQuery.mbYTPlayer.controls.unmute), jQuery(t).addClass("isMuted"), jQuery(t).trigger("YTPMuted")
        },
        unmuteYTP: function () {
            var t = this.get(0);
            t.player.unMute(), t.player.setVolume(t.opt.vol), jQuery("#controlBar_" + t.id).find(".mb_YTVPMuteUnmute").html(jQuery.mbYTPlayer.controls.mute), jQuery(t).removeClass("isMuted"), jQuery(t).trigger("YTPUnmuted")
        },
        ...
        checkForState: function (t) {
            ...
            clearInterval(t.getState), t.getState = setInterval(function () {
                var e = jQuery(t).manageYTPProgress(),
                    i = jQuery(t),
                    n = jQuery("#controlBar_" + t.id),
                    r = t.opt,
                    o = t.opt.startAt ? t.opt.startAt : 1,
                    s = t.opt.stopAt > t.opt.startAt ? t.opt.stopAt : 0;
                if (s = s < t.player.getDuration() ? s : 0, t.player.time != e.currentTime) {
                    var a = jQuery.Event("YTPTime");
                    a.time = t.player.time, jQuery(t).trigger(a)
                }
                if (t.player.time = e.currentTime, 0 == t.player.getVolume() ? i.addClass("isMuted") : i.removeClass("isMuted"), t.opt.showControls && (e.totalTime ? n.find(".mb_YTVPTime").html(jQuery.mbYTPlayer.formatTime(e.currentTime) + " / " + jQuery.mbYTPlayer.formatTime(e.totalTime)) : n.find(".mb_YTVPTime").html("-- : -- / -- : --")), document.hasFocus() ? document.hasFocus() && !t.hasFocus && (t.hasFocus = !0, i.playYTP()) : 1 == t.state && (t.hasFocus = !1, i.pauseYTP()), 1 == t.player.getPlayerState() && (parseFloat(t.player.getDuration() - 3) < t.player.getCurrentTime() || s > 0 && parseFloat(t.player.getCurrentTime()) > s)) {
                    if (t.isEnded) return;
                    if (t.isEnded = !0, setTimeout(function () {
                        ...
                        return l.time = t.player.time, void jQuery(t).trigger(l)
                    }
                    r.loop ? t.player.seekTo(o, !0) : (t.player.pauseVideo(), t.wrapper.CSSAnimate({
                        opacity: 0
                    }, 1e3, function () {
                        var e = jQuery.Event("YTPEnd");
                        if (e.time = t.player.time, jQuery(t).trigger(e), t.player.seekTo(o, !0), !t.isBackground) {
        ...
        var t = this.get(0);
        if (t) return t.player.isMuted() ? (jQuery(t).unmuteYTP(), !0) : (jQuery(t).muteYTP(), !1)
    ...
    e.prototype = {
        ...
        typewrite: function (t, e) {
            if (!0 !== this.stop) {
                ...
                n.timeout = setTimeout(function () {
                    ...
                    if ("^" === r.charAt(0)) {
                        var o = 1;
                        /^\^\d+/.test(r) && (o += (r = /\d+/.exec(r)[0]).length, i = parseInt(r)), t = t.substring(0, e) + t.substring(e + o)
                    }
        ...
        backspace: function (t, e) {
            if (!0 !== this.stop) {
                ...
                n.timeout = setTimeout(function () {
                    ...
                    var r = t.substr(0, e);
                    n.attr ? n.el.attr(n.attr, r) : n.isInput ? n.el.val(r) : "html" === n.contentType ? n.el.html(r) : n.el.text(r), e > n.stopNum ? (e--, n.backspace(t, e)) : e <= n.stopNum && (++n.arrayPos === n.strings.length ? (n.arrayPos = 0, n.shuffle && (n.sequence = n.shuffleArray(n.sequence)), n.init()) : n.typewrite(n.strings[n.sequence[n.arrayPos]], e))
                }, i)
            }
        },
        ...
        return this.each(function () {
            var n = t(this),
                r = n.data("typed"),
                o = "object" == typeof i && i;
            r && r.reset(), n.data("typed", r = new e(this, o)), "string" == typeof i && r[i]()
        })
    }, t.fn.typed.defaults = {
...
function (t) {
    ...
    function e(e) {
        return this.each(function () {
            ...
            (o || "destroy" != e) && (o || i.data("bs.validator", o = new n(this, r)), "string" == typeof e && o[e]())
        })
    }
    var i = ':input:not([type="submit"], button):enabled:visible',
        n = function (e, i) {
            this.$element = t(e), this.options = i, i.errors = t.extend({}, n.DEFAULTS.errors, i.errors);
            for (var r in i.custom)
                if (!i.errors[r]) throw new Error("Missing default error message for custom validator: " + r);
            t.extend(n.VALIDATORS, i.custom), this.$element.attr("novalidate", !0), this.toggleSubmit(), this.$element.on("input.bs.validator change.bs.validator focusout.bs.validator", t.proxy(this.validateInput, this)), this.$element.on("submit.bs.validator", t.proxy(this.onSubmit, this)), this.$element.find("[data-match]").each(function () {
                var e = t(this),
                    i = e.data("match");
    ...
    n.DEFAULTS = {
        ...
        if (i.is('[type="radio"]') && (i = this.$element.find('input[name="' + i.attr("name") + '"]')), this.$element.trigger(e = t.Event("validate.bs.validator", {
            ...
            this.runValidators(i).done(function (o) {
                i.data("bs.validator.errors", o), o.length ? r.showErrors(i) : r.clearErrors(i), n && o.toString() === n.toString() || (e = o.length ? t.Event("invalid.bs.validator", {
                    relatedTarget: i[0],
                    detail: o
                }) : t.Event("valid.bs.validator", {
                    relatedTarget: i[0],
                    detail: n
                }), r.$element.trigger(e)), r.toggleSubmit(), r.$element.trigger(t.Event("validated.bs.validator", {
                    relatedTarget: i[0]
                }))
            })
        }
        ...
        function i(t) {
            return e.data(t + "-error") || e.data("error") || "native" == t && e[0].validationMessage || s.errors[t]
        }
        var r = [],
            o = t.Deferred(),
            s = this.options;
        return e.data("bs.validator.deferred") && e.data("bs.validator.deferred").reject(), e.data("bs.validator.deferred", o), t.each(n.VALIDATORS, t.proxy(function (t, n) {
            if ((e.data(t) || "native" == t) && !n.call(this, e)) {
                var o = i(t);
                !~r.indexOf(o) && r.push(o)
            }
        }, this)), !r.length && e.val() && e.data("remote") ? this.defer(e, function () {
            var n = {};
            n[e.attr("name")] = e.val(), t.get(e.data("remote"), n).fail(function (t, e, n) {
                r.push(i("remote") || n)
            }).always(function () {
                o.resolve(r)
            })
        }) : o.resolve(r), o.promise()
    }, n.prototype.validate = function () {
        var t = this.options.delay;
        return this.options.delay = 0, this.$element.find(i).trigger("input.bs.validator"), this.options.delay = t, this
    }, n.prototype.showErrors = function (e) {
        var i = this.options.html ? "html" : "text";
        this.defer(e, function () {
            var n = e.closest(".form-group"),
                r = n.find(".help-block.with-errors"),
                o = n.find(".form-control-feedback"),
                s = e.data("bs.validator.errors");
            s.length && (s = t("<ul/>").addClass("list-unstyled").append(t.map(s, function (e) {
                return t("<li/>")[i](e)
            })), void 0 === r.data("bs.validator.originalContent") && r.data("bs.validator.originalContent", r.html()), r.empty().append(s), n.addClass("has-error"), o.length && o.removeClass(this.options.feedback.success) && o.addClass(this.options.feedback.error) && n.removeClass("has-success"))
        })
        ...
        i.html(i.data("bs.validator.originalContent")), e.removeClass("has-error"), n.length && n.removeClass(this.options.feedback.error) && n.addClass(this.options.feedback.success) && e.addClass("has-success")
        ...
        return !!this.$element.find(i).filter("[required]").filter(function () {
        ...
        return i = t.proxy(i, this), this.options.delay ? (window.clearTimeout(e.data("bs.validator.timeout")), void e.data("bs.validator.timeout", window.setTimeout(i, this.options.delay))) : i()
    ...
    t.fn.validator = e, t.fn.validator.Constructor = n, t.fn.validator.noConflict = function () {
...
}(jQuery), $("#contactForm").validator().on("submit", function (t) {
    t.isDefaultPrevented() ? (formError(), submitMSG(!1, "Did you fill in the form properly?")) : (t.preventDefault(), submitForm())
});
